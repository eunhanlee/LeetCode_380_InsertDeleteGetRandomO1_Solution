...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(randomizedSet.insert(1)); // Inserts 1 into the set. Returns true as 1 was inserted successfully.
        System.out.println(randomizedSet.remove(2));// Returns false as 2 does not exist in the set.
        System.out.println(randomizedSet.insert(2));// Inserts 2 into the set, returns true. The set now contains [1,2].
        System.out.println(randomizedSet.getRandom()); // getRandom() should return either 1 or 2 randomly.
        System.out.println(randomizedSet.remove(1));// Removes 1 from the set, returns true. The set now contains [2].
